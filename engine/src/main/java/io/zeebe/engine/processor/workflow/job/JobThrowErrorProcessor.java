...
public class JobThrowErrorProcessor implements CommandProcessor<JobRecord> {
  ...
  private static final String INVALID_JOB_STATE_MESSAGE =
      "Expected to throw an error for job with key '%d', but the job is in state '%s'";
